...
# Optional object-centric swarm extension; upstream routes and services stay intact.
import os
if os.environ.get("SWARM_ENABLED", "false").lower() == "true":
    from app.swarm.interfaces.api import install
    from app.interfaces.dependencies import get_current_user, resolve_ws_user
    install(app, auth=get_current_user)
    app.state.swarm_ws_auth = resolve_ws_user
